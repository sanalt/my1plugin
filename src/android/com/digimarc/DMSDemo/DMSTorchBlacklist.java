...
/*
#########################################################################
####################### Android Torch Blacklist #########################
# The torch feature will be hidden from devices in this blacklist.
#
# To add a device to this list:
# 1. Find the device on http://new.glbenchmark.com/
# 2. View the System Information page 
# 3. Under android.os.Build.MODEL, enter all entries for the device 
# 4. Add the device name to mBlackList in the static initializer below.
#########################################################################
*/

public class DMSTorchBlacklist {
    private static List<String> mBlackList = new LinkedList<String>();
    ...
    public static boolean isSupported(String deviceName) {
        return !mBlackList.contains(deviceName);
    }
}
